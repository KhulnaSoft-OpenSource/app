...
const RepositoriesCartTemplate: ComponentStory<typeof RepositoriesCart> = (args) => (
  <RepositoriesCart {...args}>
    <RepositoryCartItem handleRemoveItem={() => {}} avatar="" totalPrs={120} orgName="open khulnasoft" repoName="hot" />
    <RepositoryCartItem
      handleRemoveItem={() => {}}
      avatar=""
      totalPrs={120}
      orgName="open khulnasoft"
      repoName="insights"
    />
    <RepositoryCartItem
      handleRemoveItem={() => {}}
...
WithHistory.args = {
  history: [
    { orgName: "open khulnasoft", repoName: "insights", totalPrs: 87, handleRemoveItem: () => {} },
