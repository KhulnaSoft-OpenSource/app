...
const TypographyTemplate: StoryFn<typeof TypographyWrapper> = (args) => (
  <TypographyWrapper {...args}>
    <p className="lead">
      Until now, trying to style an article, document, or blog post in KhulnaSoft Insights has been a tedious task that
      required a keen eye for typography and a lot of complex custom CSS.
    </p>
    <p>
      By default, KhulnaSoft Insights removes all of the default browser styling from paragraphs, headings, lists and
    ...
    <blockquote>
      <p>
        Why is KhulnaSoft Insights removing the default styles on my <code>h1</code> elements? How do I disable this?
    ...
    <p>
      ...
      <a href="https://insights.khulnasoft.com">this link to the KhulnaSoft Insights website</a>. We almost made them
