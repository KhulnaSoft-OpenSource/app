...
export default function SEO({ description, image, title, twitterCard, noindex }: SEOobject) {
  return (
    <Head>
      <title key="title">{title || "KhulnaSoft Insights"}</title>
      <meta name="title" content={title || "KhulnaSoft Insights"} key="metatitle" />
      <meta
        name="description"
        content={
          description ||
      ...
      <meta property="og:title" content={title || "KhulnaSoft Insights"} key="og:title" />
      <meta
      ...
      <meta property="og:site_name" content="KhulnaSoft Insights" key="og:site_name" />
      <meta property="og:type" content="website" key="og:type" />

      <meta name="twitter:title" content={title || "KhulnaSoft Insights"} key="twitter:title" />
      <meta
