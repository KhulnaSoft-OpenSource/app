        ...
        <div>
          ...
          <div className="mb-4 text-left ">
            <Text className="!text-sm">
              Before we start indexing open-source projects with KhulnaSoft, we will need you to authenticate with your
              GitHub account:
            </Text>
          </div>
    ...
    <Card className="flex flex-col lg:flex-row w-[870px] min-h-[480px] !p-0 rounded-none lg:rounded-lg !bg-inherit lg:!bg-light-slate-2 lg:shadow-login !border-0 lg:!border-[1px] lg:!border-orange-500">
      <>
        <section className="w-full max-w-50%  p-6 lg:p-9">
          ...
          <div className="mb-8">
            <Text className="!text-sm">
              KhulnaSoft OpenSource is a platform to provide insights on open source contributions.{" "}
            </Text>
          </div>
